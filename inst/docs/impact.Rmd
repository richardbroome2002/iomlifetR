---
title: "Impact"
author: "Josh Horsley and Richard Broome"
date: "`r Sys.Date()`"
...
Plot a comparison of no lag and US EPA lag (Current cohort)
```{r}
plot(rownames(no_lag), no_lag$deaths_current,
     xlab = "Year", ylab = "Number",
     main = "Deaths avoided (current cohort)", type = "b")
points(rownames(epa_lag), epa_lag$deaths_current, col = "red", type = "b")
abline(h = 0)
